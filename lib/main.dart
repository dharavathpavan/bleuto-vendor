  ...
  if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDJ-xmM8v0fzP0GFzm0ThOwaLiBJ-G2hxQ",
        appId: "1:944480415549:android:be75bbbf5c8b279574df54",
        messagingSenderId: "944480415549",
        projectId: "bleuto-vendor",
      ),
    );
  }else {
    await Firebase.initializeApp();
